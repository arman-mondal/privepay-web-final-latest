            ...
            <section id="hero" className="relative px-[20%] min-h-[140vh] mt-[10%]">
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <strong>User:</strong> Any individual or entity that registers for or uses the app.
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <strong>Registration:</strong> Users must create an account by providing accurate and complete information, including name, email address, and payment details.
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <strong>Payment Methods:</strong> Users can make payments using various methods, including credit/debit cards, UPI, and e-wallets. All payments are processed through secure third-party payment gateways.
                            </li>
                            <li>
                                <strong>Charges:</strong> Users agree to pay all charges associated with their bookings, including applicable taxes and fees. The total amount will be displayed at the time of booking.
                            </li>
                            <li>
                                <strong>Payment Confirmation:</strong> Upon successful payment, users will receive a confirmation email or notification with booking details.
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li>
                                <strong>Booking Process:</strong> Users can browse and book dining reservations and event tickets through the app. Availability is subject to the service provider’s terms.
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <strong>Compliance:</strong> Users must use the app in compliance with all applicable laws and regulations.
                            </li>
                            <li>
                                <strong>Prohibited Activities:</strong> Users must not engage in fraudulent activities, misuse the app, or interfere with other users’ enjoyment of the app.
                            </li>
                            <li>
                                <strong>Accountability:</strong> Users are responsible for any charges incurred due to unauthorized use of their account.
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                            <li>
                                <strong>Service Quality:</strong> Service providers must honor bookings made through the app and provide services as described.
                            </li>
                            <li>
                                <strong>Accurate Information:</strong> Service providers are responsible for providing accurate and up-to-date information about their services, including availability, pricing, and policies.
                            </li>
                            <li>
                                <strong>Compliance:</strong> Service providers must comply with all applicable laws and regulations, including health and safety standards.
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <strong>Jurisdiction:</strong> These terms and conditions are governed by the laws of [Jurisdiction]. Any legal action arising from these terms and conditions must be filed in the courts of [Jurisdiction].
                            </li>
                        </ul>
                    </li>
                    <li>
