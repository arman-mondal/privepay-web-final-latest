...
export default function Privacy() {
        return (
           <div className="content-container relative px-[20%] min-h-[100vh] mt-[10%]">
    ...
    <p className="content-text">
        ...
        AMEYA ENTERPRISES, whose registered/operational
        office is
                    208,GIRISH HEIGHTS,NEAR LIC SQUARE,SADAR
            Nagpur
            MAHARASHTRA
            440001
    ...
    <ul className="unorder-list">
        ...
        <li className="list-item">
            <p className="content-text list-text">
                ...
                AMEYA ENTERPRISES’s prior written consent.
            </p>
        </li>
        <li className="list-item">
            <p className="content-text list-text">
